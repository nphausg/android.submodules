...
package com.nphau.android.shared.server

import android.net.Uri
import android.os.Build
import com.nphau.android.Launcher
import com.nphau.android.shared.common.extensions.ioScope
import com.nphau.android.shared.common.extensions.tag
import com.nphau.android.shared.common.functional.tryOrNull
import com.nphau.android.shared.libs.file.FileUtils
import com.nphau.android.shared.libs.NetworkUtils
import com.nphau.android.shared.libs.crypto.decodeBase64
import com.nphau.android.shared.libs.crypto.toBase64
import com.nphau.android.shared.libs.file.BitmapUtils
...
import com.nphau.android.shared.data.entities.MediaType
...
object LocalServer {
    ...
    private fun resolveFile(parameters: String): File? {
        ...
        val path = FileUtils.getPhysicalPath(com.nphau.android.Launcher.appContext, uri)
        ...
        if (type == MediaType.IMAGE.name) {
            if (!BitmapUtils.isNormalOrientation(path)) {
                BitmapUtils
                    .createRotatedFile(com.nphau.android.Launcher.appContext, path)
                    ?.let { file = it }
            }
        }
        return file
