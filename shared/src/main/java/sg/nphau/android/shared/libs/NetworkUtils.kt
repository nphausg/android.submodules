...
import sg.nphau.android.shared.common.extensions.applySingleIoScheduler
import sg.nphau.android.shared.common.extensions.observableFromCallable
import sg.nphau.android.shared.common.extensions.singleFromCallable
...
fun InetAddress.isV4(): Boolean {
    return this is Inet4Address
}

fun InetAddress.isV6(): Boolean {
